...
class AppUser {
    ...
    final newUser = AppUser._(
      ...
      challengeCompletionDate: json['challengeCompletionDate'] == null
          ...
          : DateTime.fromMillisecondsSinceEpoch(
              json['challengeCompletionDate']),
      challengeStartDate: json['challengeStartDate'] == null
          ? null
          : DateTime.fromMillisecondsSinceEpoch(json['challengeStartDate']),
      registrationDate:
      ...
      tasksNotCompletedOnFailureDay:
          json['tasksNotCompletedOnFailureDay'] ?? [],
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'challengeCompletionDate':
          this.challengeCompletionDate?.millisecondsSinceEpoch,
      ...
      'completions':
          completions.map((key, value) => MapEntry(key, value.toList())),
  ...
  AppUser copyWith({
    ...
    return AppUser._(
      ...
      challengeCompletionDate:
          challengeCompletionDate ?? this.challengeCompletionDate,
      ...
      tasksNotCompletedOnFailureDay: tasksNotCompletedOnFailureDay?.toList() ??
          this.tasksNotCompletedOnFailureDay,
    );
  }
